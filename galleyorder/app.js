...
(function () {
  ...
  const GROUPS = [
    { id: "proteins", label: "Fresh Order · Proteins", cats: ["fish", "meat"] },
    { id: "produce", label: "Produce · Veg & Fruit", cats: ["produce"] },
    { id: "cold-storage", label: "Cold Storage", cats: ["cheese-dairy", "freezer"] },
    { id: "pantry-core", label: "Pantry Core · Dry Storage", cats: ["western", "grains-pasta", "spices"] },
    { id: "patisserie", label: "Patisserie · Bakery", cats: ["bakery"] },
  ...
  function openUploadListModal() {
    ...
    const html = `
      ...
      <div class="modal-help">
        ...
        <p>Paste a supplier email, WhatsApp message, hand-written list, or a chef-to-chef hand-off list. The parser reads each line, finds the closest match in the 2,512-item catalog, and lets you review every match before anything touches your order.</p>
  ...
  function openAboutModal() {
    const html = `
      ...
      <p>A free, open provisioning tool. 2,512 items catalogued — heritage rices, sashimi-grade tunas, Bronte pistachio paste, Walkerswood jerk, Pixian doubanjiang, real wasabi root — with the brand or grade that makes the difference noted on every line.</p>
    ...
    const html = `
      ...
      <div class="onboard-grid">
        <div class="onboard-step">
          ...
          <div class="onboard-text"><strong>Browse or search.</strong> Click a category in the sidebar, or type into the search bar. 2,512 items across 18 categories.</div>
        </div>
        <div class="onboard-step">
