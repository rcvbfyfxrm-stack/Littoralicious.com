...
window.PANTRY_ENRICH = (function () {
  ...
  const portions = [
    ...
    { cat: "produce", role: "all", name: /^tomato/i,
      perPaxPerDay: 0.05, unit: "kg", minQty: 1, note: "S - 50 g tomato / pax / day (salad + sauce + side)" },
    { cat: "produce", role: "all", name: /^cherry tomato|datterini|piccadilly/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "S - 25 g cherry tomato / pax / day" },
    { cat: "produce", role: "all", name: /^onion(?!s?\b.*spring|s?\b.*green|s?\b.*pearl)/i,
      perPaxPerDay: 0.04, unit: "kg", minQty: 1, note: "S - 40 g onion / pax / day" },
    { cat: "produce", role: "all", name: /^shallot/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.5, note: "S - 15 g shallot / pax / day" },
    { cat: "produce", role: "all", name: /^garlic(?!\s+chive)/i,
      perPaxPerDay: 0.008, unit: "kg", minQty: 0.5, note: "S - 8 g garlic / pax / day" },
    { cat: "produce", role: "all", name: /^potato/i,
      perPaxPerDay: 0.08, unit: "kg", minQty: 2, note: "S - 80 g potato / pax / day (sides + mash + roast)" },
    { cat: "produce", role: "all", name: /^carrot/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 1, note: "S - 25 g carrot / pax / day" },
    { cat: "produce", role: "all", name: /^cucumber/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 1, note: "S - 25 g cucumber / pax / day" },
    { cat: "produce", role: "all", name: /^bell pepper|^pepper.*(red|yellow|green|orange)|^capsicum/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 1, note: "S - 25 g bell pepper / pax / day" },
    { cat: "produce", role: "all", name: /^lemon(?!grass)/i,
      perPaxPerDay: 0.3, unit: "pcs", minQty: 6, note: "S - 1 lemon / 3 pax / day (cook + drink + garnish)" },
    { cat: "produce", role: "all", name: /^lime(?!stone|.*finger|.*makrut|.*kaffir|.*leaves)/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 4, note: "S - 1 lime / 5 pax / day" },
    { cat: "produce", role: "all", name: /^banana(?!\s+blossom|\s+leaf|\s+leaves|\s+flower)/i,
      perPaxPerDay: 0.4, unit: "pcs", minQty: 6, note: "S - breakfast + smoothies + dessert" },
    { cat: "produce", role: "all", name: /^apple/i,
      perPaxPerDay: 0.35, unit: "pcs", minQty: 6, note: "S - snack + dessert + sauce" },
    { cat: "produce", role: "all", name: /^strawberr/i,
      perPaxPerDay: 0.05, unit: "kg", minQty: 0.5, note: "S - 50 g strawberry / pax / day" },
    { cat: "produce", role: "all", name: /^blueberr/i,
      perPaxPerDay: 0.04, unit: "kg", minQty: 0.5, note: "S - 40 g blueberry / pax / day - #1 berry" },
    { cat: "produce", role: "all", name: /^avocado(?!\s+leaf|\s+leaves)/i,
      perPaxPerDay: 0.4, unit: "pcs", minQty: 6, note: "S - breakfast + guac + plating" },
    { cat: "produce", role: "all", name: /butter lettuce|^bibb|^romaine|^iceberg|^little gem|^baby gem/i,
      perPaxPerDay: 0.25, unit: "heads", minQty: 4, note: "S - 1 head / 4 pax / day" },

    // --- TIER A - Crowd-pleasers (2-3 services / week) ---
    { cat: "produce", role: "all", name: /^broccoli\b(?!ni)/i,
      perPaxPerDay: 0.03, unit: "kg", minQty: 1, note: "A - 30 g broccoli / pax / day - top-3 US veg" },
    { cat: "produce", role: "all", name: /broccolini|tenderstem|sprouting broccoli/i,
      perPaxPerDay: 0.1, unit: "bunch", minQty: 2, note: "A - 1 bunch / 10 pax / day" },
    { cat: "produce", role: "all", name: /baby spinach|^spinach/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "A - 25 g spinach / pax / day" },
    { cat: "produce", role: "all", name: /^white mushroom|^cremini|^button mushroom|^chestnut mushroom|portobello/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "A - 25 g common mushroom / pax / day" },
    { cat: "produce", role: "all", name: /^zucchini|courgette/i,
      perPaxPerDay: 0.03, unit: "kg", minQty: 1, note: "A - 30 g zucchini / pax / day" },
    { cat: "produce", role: "all", name: /^asparagus.*green|^green asparagus|^asparagus$/i,
      perPaxPerDay: 0.15, unit: "bunch", minQty: 2, note: "A - 1 bunch (~500g) / ~7 pax / day" },
    { cat: "produce", role: "all", name: /^raspberr/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "A - 25 g raspberry / pax / day" },
    { cat: "produce", role: "all", name: /^blackberr/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "A - 20 g blackberry / pax / day" },
    { cat: "produce", role: "all", name: /^mango(?!steen)/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 3, note: "A - 1 mango / 5 pax / day" },
    { cat: "produce", role: "all", name: /^pineapple/i,
      perPaxOnce: 0.15, unit: "pcs", minQty: 2, note: "A - ~1.5 pineapple / 10 pax / week" },
    { cat: "produce", role: "all", name: /^watermelon(?!\s+radish)/i,
      perPaxOnce: 0.1, unit: "pcs", minQty: 1, note: "A - 1 watermelon / 10 pax / week" },
    { cat: "produce", role: "all", name: /^cantaloupe|^honeydew|^charentais|^canary melon|^melon$/i,
      perPaxOnce: 0.25, unit: "pcs", minQty: 2, note: "A - ~1 melon / 4 pax / week" },
    { cat: "produce", role: "all", name: /^orange(?! blossom)/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 4, note: "A - juice + dessert + carpaccio" },
    { cat: "produce", role: "all", name: /^grape(?!fruit)/i,
      perPaxPerDay: 0.04, unit: "kg", minQty: 0.5, note: "A - 40 g grapes / pax / day - cheese board + snack" },
    { cat: "produce", role: "all", name: /^pear(?:s|\b)/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 4, note: "A - 1 pear / 5 pax / day" },
    { cat: "produce", role: "all", name: /^celery\b/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "A - 20 g celery / pax / day - mirepoix + crudite" },
    { cat: "produce", role: "all", name: /baby corn|^sweet corn|^corn on the cob/i,
      perPaxPerDay: 0.3, unit: "pcs", minQty: 4, note: "A - 1 cob / ~3 pax / day" },
    { cat: "produce", role: "all", name: /^green bean|haricot vert|french bean/i,
      perPaxPerDay: 0.04, unit: "kg", minQty: 0.5, note: "A - 40 g green beans / pax / day" },
    { cat: "produce", role: "all", name: /^pea(?!\s+shoot|\s+tendril)\b|sugar snap|snow pea/i,
      perPaxPerDay: 0.03, unit: "kg", minQty: 0.5, note: "A - 30 g peas / pax / day" },
    ...
    { cat: "produce", role: "all", name: /^mint(?:\b|\s)/i,
      perPaxPerDay: 0.06, unit: "bunch", minQty: 1, note: "B - 1 bunch / ~16 pax / day" },
    ...
    { cat: "produce", role: "all", name: /^ginger\b/i,
      perPaxPerDay: 0.005, unit: "kg", minQty: 0.2, note: "B - 5 g ginger / pax / day" },
    { cat: "produce", role: "all", name: /^peach(?!es?.*frozen)/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 4, note: "B - 1 peach / 5 pax / day - seasonal" },
    ...
    { cat: "produce", role: "all", name: /^kiwi/i,
      perPaxPerDay: 0.2, unit: "pcs", minQty: 4, note: "B - 1 kiwi / 5 pax / day" },
    ...
    { cat: "produce", role: "all", name: /^leek/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.5, note: "B - 15 g leek / pax / day" },
    { cat: "produce", role: "all", name: /^fennel/i,
      perPaxPerDay: 0.012, unit: "kg", minQty: 0.5, note: "B - 12 g fennel / pax / day" },
    { cat: "produce", role: "all", name: /sweet potato|^yam(?:\b|s)/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "B - 25 g sweet potato / pax / day" },
    { cat: "produce", role: "all", name: /brussels sprout/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "B - 20 g Brussels sprouts / pax / day" },
    { cat: "produce", role: "all", name: /^aubergine|^eggplant/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "B - 20 g eggplant / pax / day" },
    ...
    { cat: "produce", role: "all", name: /^mandarin|^clementine|^tangerine/i,
      perPaxPerDay: 0.3, unit: "pcs", minQty: 6, note: "B - 1 mandarin / 3 pax / day - snack" },
    ...
    { cat: "produce", role: "all", name: /^cabbage\s+savoy|^white cabbage|^green cabbage|^cabbage$/i,
      perPaxPerDay: 0.1, unit: "heads", minQty: 1, note: "B - 1 head / 10 pax / day" },
    ...
    { cat: "produce", role: "all", section: /^tomatoes/i,
      perPaxPerDay: 0.04, unit: "kg", minQty: 1, note: "S - tomato section · 40 g / pax / day" },
    { cat: "produce", role: "all", section: /^peppers|peppers — sweet/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "S - pepper section · 25 g / pax / day" },
    { cat: "produce", role: "all", section: /squash|gourd|marrow/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "B - squash · 25 g / pax / day" },
    { cat: "produce", role: "all", section: /aubergine|eggplant|fennel|mediterranean/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "B - mediterranean veg · 20 g / pax / day" },
    { cat: "produce", role: "all", section: /melons|grapes/i,
      perPaxOnce: 0.2, unit: "pcs", minQty: 2, note: "A - melon/grape mix · 1 / 5 pax / week" },
    { cat: "produce", role: "all", section: /leafy greens/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.3, note: "fallback - leafy 20 g / pax / day" },
    { cat: "produce", role: "all", section: /brassicas/i,
      perPaxPerDay: 0.02, unit: "kg", minQty: 0.5, note: "fallback - brassicas 20 g / pax / day" },
    { cat: "produce", role: "all", section: /roots|tubers/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.5, note: "fallback - roots 15 g / pax / day" },
    { cat: "produce", role: "all", section: /alliums/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.5, note: "fallback - alliums 15 g / pax / day" },
    { cat: "produce", role: "all", section: /fruiting vegetable|nightshades/i,
      perPaxPerDay: 0.025, unit: "kg", minQty: 0.5, note: "fallback - fruiting veg 25 g / pax / day" },
    { cat: "produce", role: "all", section: /^herbs|fresh herbs|aromatics/i,
      perPaxPerDay: 0.05, unit: "bunch", minQty: 1, note: "fallback - 1 bunch / 20 pax / day" },
    { cat: "produce", role: "all", section: /berries/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.5, note: "fallback - berries 15 g / pax / day" },
    { cat: "produce", role: "all", section: /citrus/i,
      perPaxPerDay: 0.15, unit: "pcs", minQty: 4, note: "fallback - citrus 1 / 7 pax / day" },
    ...
    { cat: "produce", role: "all", section: /stone fruit|orchard|pome/i,
      perPaxPerDay: 0.15, unit: "pcs", minQty: 4, note: "fallback - stone fruit 1 / 7 pax / day" },
    { cat: "produce", role: "all", section: /mushroom/i,
      perPaxPerDay: 0.015, unit: "kg", minQty: 0.3, note: "fallback - mushroom 15 g / pax / day" },
