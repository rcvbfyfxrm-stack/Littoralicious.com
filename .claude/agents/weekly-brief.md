---
name: weekly-brief
description: Generate the Littoralicious Weekly Brief — connected digest of seasonal ingredient, technique, science, coastal heritage, world chef news, and yacht industry intelligence. Triggered by `make weekly` from the littoralicious root.
model: sonnet
