...
window.PCV_DATA = (function () {
  ...
  },
  {
    ...
    "why": "★★ (promoted from ★ in November 2025 — the news of the 2026 guide). À commander : the 25-course tasting; dishes are not named until after you eat them. Albert Adrià — Ferran's brother, the elBarri group founder. Bodega 1900, Tickets, Pakta, Hoja Santa all closed in 2020; Enigma was the sole survivor. Now promoted to ★★ and the elBulli legacy lives most directly here.",
  ...
  },
  {
    ...
    "why": "★★ (promoted from ★ in November 2025 — most discussed promotion of the 2026 guide). À commander : sobrasada and Mahón cheese mochi; the sea-cucumber 'carbonara'; the creative pintxo opening series. Chef Fran Agudo, ex-Tickets (elBarri). The gastrobar format reaches ★★ — a Barcelona statement.",
  ...
  },
  {
    ...
    "why": "★★ (promoted from ★ in November 2025). À commander : the ingredient-led seasonal tasting — pared-back plates that let produce speak. Chefs Paulo Airaudo (Italo-Argentine) + Rafa de Bedoya (Jerez). Inside Hotel Casa Fuster, a 1908 Domènech i Montaner Modernista building.",
  ...
  },
  {
    ...
    "why": "Michelin recommended — the canonical Raval table. À commander : anchoas de Santoña (Cantabrian anchovies), gamba de Palamós (the great prawn — €19–22), fideuà Cañete, the pa amb tomàquet. Two blocks from the Liceu. The ringside counter is the best seat. Tapas €5–20 each.",
  ...
  },
  {
    ...
    "why": "★ — small-producer Catalan. À commander : the Tasting (longer) or Essence (shorter) menu — pa amb tomàquet sequence, Penedès wine pairing. Jordi Artal, Canadian-Catalan, self-taught. The relationships with small Catalan producers (cheese, oil, vegetables) are the spine.",
  ...
  },
  {
    ...
    "why": "Since 1836 — the paella institution; the Paella Parellada was invented here. À commander : Paella Parellada (boneless meat + shellfish, the house classic), arròs amb llagosta, fideuà, suquet de peix. Daily 13:00–01:00 (continuous service). The 19th-century vaulted dining room with name-plates of historic patrons is the experience.",
  ...
  },
  {
    ...
    "why": "Cash-only, no sign — where la bomba was invented (Civil War era). À commander : la bomba (fried potato sphere holding seasoned meat, paprika dust, allioli + brava sauces), grilled sardines, clams, sepia. Family-run on a Barceloneta corner since 1944. Cash only. OAD Casual Europe #81 (2025). The bomba in any other bar is a copy of this one.",
  ...
  },
  {
    ...
    "why": "The Poblenou seafood benchmark — suquet de peix with authority. À commander : suquet de peix (the fisherman's stew, definitive version), fideuà negra (squid-ink noodles), arròs a banda, fresh grilled catch of the day. Plaça de Prim is the old fishing-village square of Poblenou. The terrace is the reason.",
  ...
  },
  {
    ...
    "why": "Michelin recommended — the elBulli-trained reading of Catalan classics. À commander : the 'Los Clásicos' or 'Suculent' sharing menu — reimagined Spanish-Mediterranean classics; octopus, brava, slow-cooked meats. Chef Toni Romero (elBulli alumni). Casual format, serious cooking.",
  ...
  },
  {
    ...
    "why": "Founded 1840 on the site of the former Convent of Sant Josep — Barcelona's flagship market. À commander : the back rows (Pinotxo Bar, Bar Central — locals eat here), jamón ibérico bellota, Catalan goat cheeses, salt-cured anchovies, fresh figs and tomatoes in season. Closed Sunday. The front-row stalls near La Rambla are tourist-oriented; the real market is at the back.",
  ...
  },
  {
    ...
    "why": "1882 iron market by Antoni Rovira i Trias — reopened in 2018 after eight years of restoration. À commander : the Sunday morning book + collectibles market on the perimeter; the produce inside (Tue–Sat); after-market vermut at Bar Calders one block south. The Sant Antoni vermut neighborhood orbits this market.",
