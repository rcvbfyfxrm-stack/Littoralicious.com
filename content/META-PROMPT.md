...
|---|---|---|---|---|---|---|
| 01 | Ingredient Profile | The fast, warm field profile of one ingredient | **In scene at the encounter** — dock, crate, market, pan; 1–2 sentences, then The Cook's Reason | The Cook's Reason + vital-signs `glance` + The Pairings table with the littoral wild card + The Varieties | **The Blind Spot** — what most pros have wrong about this everyday ingredient, opening The Science | The deep-dive dossier (id-card, register ladder, compound table); a second stat grid |
| 01b | Ingredient Deep-Dive | The laboratory dossier: one ingredient, four registers | **The paradox** — the ingredient's central contradiction, stated in two lines | The Paradox + the two-minute version + 8-cell Identity Card + Four Ways + register ladder + compound table + The Fraud Test | The Frontier register + shared-molecule bridges | Shipping without Four Ways; filler examples ("several only where notable") |
