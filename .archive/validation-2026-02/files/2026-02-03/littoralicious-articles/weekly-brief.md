...
3. Read `content/template/12-weekly-brief.md` — the output template
4. Read all templates `01` through `11` — know the structure of each content type
...
title: "[Title]"
date: YYYY-MM-DD
category: [science|technique|galley|dispatch]
tags: [relevant tags]
read_time: [estimate]
