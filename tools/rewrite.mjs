...
The first law is **never lose focus**: every line earns the next. Open with the .sous block (the one line you would say out loud to your sous chef — the answer; everything below is the science behind it), one idea per <h2>, re-hook the eye every ~150 words. Do NOT close on a takeaway box: retired publication-wide 2026-09-05. No emoji. No banned words (delicious, yummy, mouthwatering, elevated, curated, artisanal, superfood, game-changer, hack). Name every source — no "studies show" without the study. British cooking spelling.
